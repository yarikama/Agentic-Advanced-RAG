...
# Read files
with open('/home/yarikama/VGMARS/src/.dataset/multihop/result_sample_10.json', 'r') as file:
    doc_data = json.load(file)

with open('/home/yarikama/VGMARS/src/.dataset/multihop/MultiHopRAG.json', 'r') as file:
...
def has_intersection(a, b):
    a_words = clean_and_tokenize(a)
    b_words = clean_and_tokenize(b)
